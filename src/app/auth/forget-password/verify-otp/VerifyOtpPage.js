...
const VerifyOtpPage = () => {
  ...
  const JWT_SECRET = new TextEncoder().encode(
    process.env.NEXT_PUBLIC_RESEND_TOKEN_SECRET_KEY
  );
  ...
  return (
    <>
      <ToastContainer />
      <div
        className="min-h-screen flex items-center justify-center bg-gray-100 px-4 w-full h-full bg-cover bg-center"
        style={{ backgroundImage: "url('/bg/benefits.jpg')" }}
      >
        <div className=" p-8 rounded-xl  w-full max-w-md ">
          <h1 className="text-5xl font-bold text-center text-purple-950">
            Verify OTP
          </h1>
          ...
          >
            ...
            <button
              type="submit"
              className={`mt-6 w-full font-semibold py-3 rounded-md transition ${
                otpExpired
