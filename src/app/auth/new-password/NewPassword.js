        ...
        <div className="font-[sans-serif] relative z-10">
          <div className="min-h-screen flex flex-col items-center justify-center py-6 px-4">
            <div className="grid md:grid-cols-2 items-center gap-4 max-w-5xl w-full">
              <button
                onClick={() => router.push("/")}
                className="absolute top-6 left-6 p-4   rounded-full text-purple-900 font-semibold hover:underline"
              >
                <FontAwesomeIcon icon={faArrowLeft} className="w-8 h-8" />
              </button>
              <div className="relative w-full mt-12 h-48 sm:h-64 md:h-80 lg:h-96 rounded-md overflow-hidden md:block lg:block xl:block hidden"></div>
