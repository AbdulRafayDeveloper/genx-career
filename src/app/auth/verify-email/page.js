...
//                         className="block w-full lg:h-[50vh] h-[200hv]"
...
//                 <main className="w-full max-w-lg p-8 relative z-10">
...
//                             <Link
//                                 href="/auth/login"
//                                 className="inline-block mt-4 bg-purple-600 hover:bg-purple-700 text-white font-semibold py-3 px-6 rounded-md transition"
//                             >
//                                 Go to Login
//                             </Link>
//                         </div>
