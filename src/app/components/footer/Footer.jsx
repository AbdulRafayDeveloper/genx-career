      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-10 font-mono">
          ...
          <div className="md:col-span-1">
            <h6 className="text-xl font-semibold text-white mb-4 font-mono">
              Our Services
            </h6>
            <ul>
              <li>
          ...
          <div className="md:col-span-1 font-mono">
            <h6 className="text-lg font-semibold text-white hover:text-purple-700 mb-4 ">
              Social Media
            </h6>
            <div className="flex flex-col gap-3">
              <Link
                href="#"
                className="flex flex-row text-white gap-2 hover:text-purple-700 transition"
                aria-label="Facebook"
              >
                <svg
                  className="w-6 h-6"
              ...
              <Link href="#" className="flex flex-row gap-2 text-white hover:text-purple-700 transition">
              ...
              <Link href="#" className="flex flex-row hover:text-purple-700 transition text-white gap-2">
