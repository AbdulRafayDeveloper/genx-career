          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-6 font-mono">
            ...
            <div className="md:col-span-1 font-mono">
              ...
              <div className="flex flex-col gap-3 mt-7">
                <Link
                  href="#"
                  className="flex flex-row text-white font-sans xl:text-lg md:text-md text-[10px] gap-2 hover:text-purple-400 transition"
                  aria-label="Facebook"
                >
                  <svg
                    className="w-6 h-6"
                ...
                <Link
                  href="#"
                  className="flex flex-row gap-2 text-white font-sans xl:text-lg md:text-md text-[10px] hover:text-purple-400 transition"
                >
                  <svg
